...
public class OilGame_Multi_UI : GameUI
{
    ...
    private void LateUpdate()
    {
        if (player1 != null)
        {
            ...
            tabletA.anchoredPosition = new Vector3(NewUI.res.x * wP.x / 16f, NewUI.res.y * wP.y / 9f);
        }
        if (player2 != null)
        {
            Vector2 wP = player2.GetWindowPos();
            tabletB.anchoredPosition = new Vector3(NewUI.res.x * wP.x / 16f, NewUI.res.y * wP.y / 9f);
        }
